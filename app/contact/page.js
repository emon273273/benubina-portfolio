                                                ...
                                                <div className="p-6 bg-yellow-50 dark:bg-yellow-900/20 border-2 border-yellow-400 dark:border-yellow-600 rounded-lg">
                                                    <div className="flex items-start gap-3">
                                                        ...
                                                        <div>
                                                            ...
                                                            <a href="mailto:hello@benubina.com" className="btn btn-sm btn-primary">
                        ...
                        <div className="space-y-4 sm:space-y-6 order-2 lg:order-2">
                            ...
                            <div className="card card-body p-6">
                                ...
                                <div className="space-y-2">
                                    <a href="mailto:hello@benubina.com" className="btn btn-sm btn-outline w-full">
                                        📧 Email Us
                                    </a>
                                    <a href="tel:+15551234567" className="btn btn-sm btn-outline w-full">
                                        📞 Call Us
                                    </a>
                                </div>
                            </div>
