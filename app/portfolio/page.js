    ...
    const projects = [
        {
            ...
            icon: ShoppingCart,
            image: 'https://images.unsplash.com/photo-1556742049-0cfed4f6a45d?ixlib=rb-4.0.3&auhref=format&fit=crop&w=800&q=80',
        ...
        },
        {
            ...
            icon: Heart,
            image: 'https://images.unsplash.com/photo-1559757148-5c350d0d3c56?ixlib=rb-4.0.3&auhref=format&fit=crop&w=800&q=80',
        ...
        },
        {
            ...
            icon: Smartphone,
            image: 'https://images.unsplash.com/photo-1563013544-824ae1b704d3?ixlib=rb-4.0.3&auhref=format&fit=crop&w=800&q=80',
        ...
        },
        {
            ...
            icon: BookOpen,
            image: 'https://images.unsplash.com/photo-1522202176988-66273c2fd55f?ixlib=rb-4.0.3&auhref=format&fit=crop&w=800&q=80',
        ...
        },
        {
            ...
            icon: Home,
            image: 'https://images.unsplash.com/photo-1560518883-ce09059eeffa?ixlib=rb-4.0.3&auhref=format&fit=crop&w=800&q=80',
        ...
        },
        {
            ...
            icon: BarChart3,
            image: 'https://images.unsplash.com/photo-1460925895917-afdab827c52f?ixlib=rb-4.0.3&auhref=format&fit=crop&w=800&q=80',
        ...
        },
        {
            ...
            icon: Wifi,
            image: 'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?ixlib=rb-4.0.3&auhref=format&fit=crop&w=800&q=80',
                                        ...
                                        >
                                            ...
                                            <div className={index % 2 === 1 ? 'lg:order-1' : ''}>
                                                <div className="space-y-6">
                                                    ...
                                                    <div className="pt-4">
                                                        <Link href="/contact" className="btn btn-primary btn-sm md:btn-lg   pb-2 mb-2 group  ">
            ...
            <section className="py-24 px-6 bg-gradient-to-br from-primary via-secondary to-accent text-primary-content relative overflow-hidden">
                ...
                <div className="max-w-4xl mx-auto text-center space-y-8 relative z-10">
                    ...
                    <div className="flex flex-col sm:flex-row gap-6 justify-center items-center pt-8">
                        <Link href="/contact" className="btn btn-lg bg-white text-primary hover:bg-gray-100 hover:scale-105 transition-all duration-300 shadow-xl group min-w-[200px]">
                            <Users className="w-5 h-5 group-hover:rotate-12 transition-transform" />
                            Start Your Project
                        </Link>
                        <Link href="/about" className="btn btn-lg btn-outline border-white text-white hover:bg-white hover:text-primary hover:scale-105 transition-all duration-300 group min-w-[200px]">
                            <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
                            Learn More About Us
                        </Link>
                    </div>
