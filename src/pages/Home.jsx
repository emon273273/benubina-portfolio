        ...
        <div className="overflow-hidden">
            ...
            <section className="py-16 sm:py-24 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-primary-600 to-secondary-600 text-white">
                <div className="max-w-4xl mx-auto text-center space-y-6 sm:space-y-8">
                    ...
                    <Link to="/contact" className="inline-flex items-center gap-2 px-8 py-4 bg-white text-primary-600 hover:bg-gray-100 rounded-lg font-semibold shadow-lg hover:shadow-xl transition-all duration-300">
                        Get In Touch
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                            <path fillRule="evenodd" d="M10.293 3.293a1 1 0 011.414 0l6 6a1 1 0 010 1.414l-6 6a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-4.293-4.293a1 1 0 010-1.414z" clipRule="evenodd" />
                        </svg>
